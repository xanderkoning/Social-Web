    ...
    // FB.getLoginStatus(function(response) {
      ...
      // if (response.status === 'connected') {
        // FB.api('/me?=fields=public_profile', function(response) {
            ...
            // full_name2 = response.name;
            // user_name2 = response.first_name;
            // password2 = 'tictactoe';
        // });
      // }
      // else {
        // return callback(create_error("login", "You have to login with Facebook first"));
      // }
    // });
    
    // Lets get the values for the registration 
    var full_name = document.getElementById('inputFullNameRegister').innerHTML;
    var user_name = document.getElementById('inputUserNameRegister').innerHTML;
    var password = document.getElementById('inputPasswordRegister').innerHTML;
